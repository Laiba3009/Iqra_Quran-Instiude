...
export default function AdminDashboard() {
  ...
  const cardClasses =
    "flex flex-col items-center justify-center text-center w-full max-w-xs h-48 md:h-56 shadow-lg rounded-xl transition transform hover:scale-105";
